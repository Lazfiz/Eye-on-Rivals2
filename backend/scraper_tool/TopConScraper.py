...
def runNews(log=False) :
    ...
    articleElements = driver.find_elements(By.CLASS_NAME, value="c-card")

    for element in articleElements:
        articleName = element.find_element(By.CLASS_NAME, value="u-color-primary-500")
    ...
    for article in NewsArticles['News']:
        ...
        postBody = driver.find_element(By.CLASS_NAME, value="c-hero")
        dateString = datetime.strptime(postBody.find_element(By.CSS_SELECTOR, 'time').text, "%B %d, %Y")
...
def runJobs(log=False):
    jobsUrl = "https://www.linkedin.com/jobs/search/?currentJobId=4267986161&f_C=65268002&geoId=92000000&origin=JOB_SEARCH_PAGE_JOB_FILTER"
